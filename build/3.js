...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApplyCashlineTenorPageModule", function() { return ApplyCashlineTenorPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__apply_cashline_tenor__ = __webpack_require__(852);
...
var ApplyCashlineTenorPageModule = /** @class */ (function () {
    function ApplyCashlineTenorPageModule() {
    }
    ApplyCashlineTenorPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__apply_cashline_tenor__["a" /* ApplyCashlineTenorPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__apply_cashline_tenor__["a" /* ApplyCashlineTenorPage */]),
            ],
        })
    ], ApplyCashlineTenorPageModule);
    return ApplyCashlineTenorPageModule;
}());

//# sourceMappingURL=apply-cashline-tenor.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ApplyCashlineTenorPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_file_countries__ = __webpack_require__(853);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_file_currencies_with_flags__ = __webpack_require__(854);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the ApplyCashlineTenorPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ApplyCashlineTenorPage = /** @class */ (function () {
    function ApplyCashlineTenorPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.isShowModal2n = false;
        this.list_country = __WEBPACK_IMPORTED_MODULE_2__assets_file_countries__["a" /* COUNTRY */].country_list;
        this.list_currency = __WEBPACK_IMPORTED_MODULE_3__assets_file_currencies_with_flags__["a" /* CURRENCY */].currency_list;
        this.list_tenor = [
            {
                month: "36 Bulan 2,09%",
                tenor: "Rp. 730.167/Bulan",
                model: false
            },
            {
                month: "24 Bulan 2,09%",
                tenor: "Rp. 359.167/Bulan",
                model: true
            },
            {
                month: "12 Bulan 2,09%",
    ...
    ApplyCashlineTenorPage.prototype.ionViewWillEnter = function () {
        console.log('ionViewDidLoad ApplyCashlineTenorPage');
        console.log(this.list_country);
        this.list_tenor.forEach(function (el, idx) {
            el['id'] = idx;
        });
    };
    ApplyCashlineTenorPage.prototype.handlerModal = function () {
        this.isShowModal2n = !this.isShowModal2n;
    };
    ApplyCashlineTenorPage.prototype.selectItem = function (item) {
        var _this = this;
        console.log(item);
        this.list_tenor.map(function (el, idx) {
            if (el.id == item.id) {
                el.model = true;
                _this.selected_item = el;
            }
            else {
                el.model = false;
            }
    ...
    ApplyCashlineTenorPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-apply-cashline-tenor',template:/*ion-inline-start:"/Users/nafirilhaq/Documents/Project/devSample/src/pages/apply-cashline-tenor/apply-cashline-tenor.html"*/'<!--\n  Generated template for the ApplyCashlineTenorPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>Apply Mega Cash Line</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <div class="limit-container">\n    <div class="limit-title" (click)="handlerModal()">Limit Mega Cash Line yang Anda Dapatkan </div>\n    <div style="display: flex; margin-top: 5px;">\n      <div>\n        <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">\n          <path d="M19.0312 5.98438H18.4184V6.61178H19.0312V5.98438Z" fill="#FA9D1C"/>\n          <path d="M19.0312 7.23828H18.4184V7.86569H19.0312V7.23828Z" fill="#FA9D1C"/>\n          <path d="M18.4141 6.60938H17.8012V7.23678H18.4141V6.60938Z" fill="#FA9D1C"/>\n          <path d="M19.6406 6.60938H19.0277V7.23678H19.6406V6.60938Z" fill="#FA9D1C"/>\n          <path d="M4.01562 10.6875H3.40273V11.3149H4.01562V10.6875Z" fill="#FA9D1C"/>\n          <path d="M4.01562 11.9414H3.40273V12.5688H4.01562V11.9414Z" fill="#FA9D1C"/>\n          <path d="M3.39844 11.3164H2.78554V11.9438H3.39844V11.3164Z" fill="#FA9D1C"/>\n          <path d="M4.625 11.3164H4.01211V11.9438H4.625V11.3164Z" fill="#FA9D1C"/>\n          <path d="M6.46094 15.0781H5.84804V15.7055H6.46094V15.0781Z" fill="#FA9D1C"/>\n          <path d="M6.46094 16.3359H5.84804V16.9633H6.46094V16.3359Z" fill="#FA9D1C"/>\n          <path d="M5.85156 15.7031H5.23867V16.3305H5.85156V15.7031Z" fill="#FA9D1C"/>\n          <path d="M7.07812 15.707H6.46523V16.3344H7.07812V15.707Z" fill="#FA9D1C"/>\n          <path d="M5.23438 0.964844H4.62148V1.59225H5.23438V0.964844Z" fill="#FA9D1C"/>\n          <path d="M5.23438 2.21875H4.62148V2.84615H5.23438V2.21875Z" fill="#FA9D1C"/>\n          <path d="M4.625 1.58984H4.01211V2.21725H4.625V1.58984Z" fill="#FA9D1C"/>\n          <path d="M5.85156 1.58984H5.23867V2.21725H5.85156V1.58984Z" fill="#FA9D1C"/>\n          <path d="M1.86719 16.3359H1.25429V16.9633H1.86719V16.3359Z" fill="#FA9D1C"/>\n          <path d="M1.86719 17.5898H1.25429V18.2172H1.86719V17.5898Z" fill="#FA9D1C"/>\n          <path d="M1.25 16.9609H0.637106V17.5883H1.25V16.9609Z" fill="#FA9D1C"/>\n          <path d="M2.48438 16.9609H1.87148V17.5883H2.48438V16.9609Z" fill="#FA9D1C"/>\n          <path d="M10.5589 9.74771H15.0449C15.5518 9.74771 15.9642 9.32548 15.9642 8.8066C15.9642 8.73448 15.9548 8.66516 15.9395 8.59766L16.5833 9.25672C17.5672 10.2641 18.1094 11.6033 18.1094 13.0276V13.1983C18.1094 16.139 15.7724 18.5312 12.8998 18.5312C10.0271 18.5312 7.69017 16.139 7.69017 13.1983V13.0276C7.69017 11.6491 8.20168 10.3533 9.12624 9.35782C9.56346 9.61046 10.0563 9.74756 10.5589 9.74756L10.5589 9.74771ZM12.8998 13.5121C12.2238 13.5121 11.674 14.075 11.674 14.7669C11.674 15.3501 12.0659 15.837 12.5933 15.9772V16.6492H13.2062V15.9772C13.7336 15.837 14.1256 15.3501 14.1256 14.7669H13.5127C13.5127 15.113 13.2378 15.3943 12.8998 15.3943C12.5617 15.3943 12.2869 15.113 12.2869 14.7669C12.2869 14.4209 12.5617 14.1395 12.8998 14.1395C13.5757 14.1395 14.1256 13.5767 14.1256 12.8847C14.1256 12.3016 13.7336 11.8146 13.2062 11.6744V11.0025H12.5933V11.6744C12.0659 11.8146 11.674 12.3016 11.674 12.8847H12.2869C12.2869 12.5387 12.5617 12.2573 12.8998 12.2573C13.2378 12.2573 13.5127 12.5387 13.5127 12.8847C13.5127 13.2308 13.2378 13.5121 12.8998 13.5121Z" fill="#38A3A5"/>\n          <path d="M15.2517 4.10038H10.2925L8.85834 2.14324C8.69622 1.92169 8.60702 1.64748 8.60702 1.37118V1.3125C8.60702 0.968687 8.73781 0.645585 8.97504 0.402761L9.03209 0.344363C9.29202 0.384136 9.44553 0.561434 9.67219 0.847541C9.93514 1.17889 10.2624 1.59075 10.9066 1.59075C11.5507 1.59075 11.8781 1.17888 12.141 0.847541C12.4002 0.520674 12.5636 0.335938 12.8995 0.335
15.538 15.1371ZM14.6584 13.1124C14.2462 13.1124 14.1912 13.4639 14.1912 13.9279C14.1912 14.3919 14.1912 14.7434 14.6584 14.7434C15.1257 14.7434 15.1257 14.3919 15.1257 13.9279C15.1257 13.4639 15.0295 13.1124 14.6172 13.1124H14.6584Z" fill="white"/>\n        </svg>\n      </div>\n      <div class="limit-value">Rp. 15.000.000</div>\n      <img src="assets/cashline/limit-ornament.png" class="limit-ornament" >\n    </div>\n  </div>\n\n  <div class="info-wrapper">\n    <div class="sof-wrapper">\n      <img src="assets/imgs/sofCard2/dd_dana.jpg" class="img-sof">\n    </div>\n    <div class="info-text">Dengan mengajukan Cashline, Anda perlu melengkapi data di bawah ini untuk \n      melakukan pembukaan rekening Bank Mega sebagai rekening penerimaan dana.</div>\n  </div>\n\n  <div class="form-container">\n  </div>\n\n  <div class="detail-cashline" padding>\n    <div class="detail-section">Detail Pencairan Mega Cash Line💰</div>\n    <div class="detail-table">\n      <div class="detail-title">Detail Pencairan Dana Mega Cash Line</div>\n      <div class="detail-content">\n        <div class="item-content">\n          <div class="item-sty">Nominal Pencairan</div>\n          <div class="item-sty" style="text-align: right;">Rp. 15.000.000</div>\n        </div>\n        <div class="item-content">\n          <div class="item-sty">Tenor</div>\n          <div class="item-sty" style="text-align: right;">36 Bulan</div>\n        </div>\n        <div class="item-content">\n          <div class="item-sty">Bunga</div>\n          <div class="item-sty" style="text-align: right;">2,09% flat</div>\n        </div>\n        <div class="item-content">\n          <div class="item-sty">Nominal Cicilan</div>\n          <div class="item-sty" style="text-align: right;">Rp. 730.167/Bulan</div>\n        </div>\n        <div class="item-content">\n          <div class="item-sty">Biaya Admin</div>\n          <div class="item-sty" style="text-align: right;">Rp. 150.000</div>\n        </div>\n      </div>\n    </div>\n  </div>\n\n</ion-content>\n\n\n<div *ngIf="isShowModal2n" id="option-modal">\n  <div class="content-wrapper">\n    <div class="header">\n      <img src="assets/icon/verify-email/close.svg" alt="logo" class="img-close" (click)="handlerModal()">\n      <div class="content-title">Pilih Tenor & Bunga</div>\n    </div>\n\n    <div class="content">\n      <div *ngFor="let item of list_tenor; let last = last;">\n        <div class="list-content" [ngStyle]="{\'border-bottom\': last ? \'0px\' : \'1px solid #dee2ee\'}" (click)="selectItem(item)">\n          <div class="valueSty" [ngClass]="{\'label-active\' : item.model}">{{item.month}}</div>\n          <div class="valueSty value-right" [ngClass]="{\'label-active\' : item.model}">{{item.tenor}}</div>\n          <ion-radio color="mega-orange" [checked]="item.model" class="radio-button"></ion-radio>\n        </div>\n      </div>\n    </div>\n\n    <div padding style="box-shadow: 0px -8px 6px -6px rgba(0, 0, 0, 0.1); background-color: white;">\n      <button class="btnLanjut" no-margin ion-button full (click)="handlerPrewashData()">Lanjut</button>\n    </div>\n  </div>\n</div>'/*ion-inline-end:"/Users/nafirilhaq/Documents/Project/devSample/src/pages/apply-cashline-tenor/apply-cashline-tenor.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */]])
    ], ApplyCashlineTenorPage);
    return ApplyCashlineTenorPage;
}());

//# sourceMappingURL=apply-cashline-tenor.js.map
...
//# sourceMappingURL=currencies-with-flags.js.map
